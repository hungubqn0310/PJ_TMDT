...
namespace _123.PaymentServices.ZaloPay
{
    public class ZaloPayRequest
    {
        ...
        public ZaloPayRequest(int appId, string appUser, long appTime, long amount, string appTransId, string bankCode, string description)
        {
            AppId = appId;
            AppUser = appUser;
            AppTime = appTime;
        ...
        public long Amount { get; set; } = string.Empty;
