...
//             // Chờ xác nhận chuyển sang trang thanh toán thành công
//             wait.Until(ExpectedConditions.UrlContains("paymentSuccessful"));
//             Console.WriteLine("Chuyển sang trang thanh toán thành công.");

//             // Xác nhận rằng URL chứa 'paymentSuccessful'
//             Assert.Contains("paymentSuccessful", driver.Url);
//             Console.WriteLine("Xác nhận chuyển sang trang thanh toán thành công.");
