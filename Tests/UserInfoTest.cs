...
//         try
//         {
//             Console.WriteLine("Bắt đầu test chức năng cập nhật thông tin cá nhân...");
//             LoginAndNavigateToUserInfo();

//             // Click vào nút "Cập nhật thông tin"
//             ClickElement(By.XPath("//button[contains(text(),'Cập nhật thông tin')]"), "Click vào nút Cập nhật thông tin");
//             wait.Until(ExpectedConditions.ElementIsVisible(By.Id("updateForm")));
//             Console.WriteLine("Form cập nhật thông tin hiển thị.");

//             // Cập nhật thông tin
//             ClearAndEnterText(By.Id("updateEmail"), "updated_email@example.com");
//             ClearAndEnterText(By.Id("updatePhone"), "0987654321");
//             ClearAndEnterText(By.Id("updateAddress"), "123 Đường ABC, Quận XYZ, Hà Nội");
//             Console.WriteLine("Đã nhập thông tin cập nhật.");

//             // Click nút "Lưu thông tin"
//             ClickElement(By.XPath("//button[contains(text(),'Lưu thông tin')]"), "Click vào nút Lưu thông tin");
            
//             // Xử lý alert thông báo (nếu có)
//             HandleAlert("Cập nhật thông tin thành công");
            
//             // Kiểm tra thông tin đã được cập nhật
//             wait.Until(ExpectedConditions.InvisibilityOfElementLocated(By.Id("updateForm")));
            
//             // Kiểm tra giá trị đã được cập nhật
//             var emailField = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("userEmail")));
//             var phoneField = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("phone")));
//             var addressField = wait.Until(ExpectedConditions.ElementIsVisible(By.Id("address")));
            
//             Assert.Equal("updated_email@example.com", emailField.GetAttribute("value"));
//             Assert.Equal("0987654321", phoneField.GetAttribute("value"));
//             Assert.Equal("123 Đường ABC, Quận XYZ, Hà Nội", addressField.GetAttribute("value"));
            
//             Console.WriteLine("Test cập nhật thông tin cá nhân thành công!");
//         }
//         catch (Exception e)
//         {
//             Console.WriteLine("Lỗi xảy ra: " + e.ToString());
//             TakeScreenshot("update_user_info_error");
//             throw;
//         }
//     }
